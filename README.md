...
| :------------------------ | :---------------------------------------------|
| Elioth Vargas (Lider del proyecto / Lider Frontend)             | Desarrollo de la arquitectura de componentes, lógica de consumo de datos (API Fetch), implementación de rutas dinámicas, maquetación general                        |
| Benjamin Vergara (Frontend / Responsive)      | Configuración responsive e Ideas de diseño de paginas    |
| Cristofer Marquez (Lider Backend)          | Configuración de Strapi, Creación de Content Types e ir configurando los roles|
